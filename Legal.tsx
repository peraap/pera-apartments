  ...
  return (
    <div className="pb-24">
      ...
      <div id="lista" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {filteredApartments.map((apt, i) => (
              ...
              >
                ...
                <div className="w-full lg:w-2/5">
                  ...
                  <p className="text-neutral-600 text-base leading-relaxed mb-10 font-description italic border-l-2 border-neutral-100 pl-4">
        ...
        <section className="py-32 bg-neutral-900 text-white rounded-[3rem] px-8 md:px-16 my-24 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
            <div>
              ...
              <p className="text-neutral-400 mb-12 leading-relaxed font-light">
        ...
        {/* Location Section */}
        <section id="localizare" className="py-24">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            <div className="w-full md:w-1/2">
              <span className="text-sm uppercase tracking-[0.3em] font-bold text-neutral-400 mb-4 block">{t.location.tag}</span>
              <h2 className="text-4xl md:text-5xl font-serif mb-8 leading-tight">{t.location.title.split('Transilvaniei.')[0]} <span className="italic font-light">{lang === 'ro' ? 'Transilvaniei.' : 'Transylvania.'}</span></h2>
              <p className="text-neutral-500 mb-8 leading-relaxed">
                {t.location.description}
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {t.location.points.map((point: any, idx: number) => (
                  <div key={idx} className="flex items-center gap-4 p-4 bg-neutral-50 rounded-2xl group hover:bg-black hover:text-white transition-all duration-300">
                    <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-sm group-hover:bg-primary-accent group-hover:text-black transition-colors">
                      <MapPin size={18} />
                    </div>
                    <div>
            ...
            <div className="w-full md:w-1/2 aspect-video bg-neutral-100 rounded-[2.5rem] overflow-hidden relative shadow-2xl">
              <iframe 
