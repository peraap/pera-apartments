          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-24">
            {features.map((f, i) => (
              ...
              >
                ...
                <p className="description-small max-w-[260px] mx-auto font-medium text-neutral-400">{f.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          <div className="max-w-xl">
            ...
            <h2 className="text-4xl md:text-6xl font-serif leading-tight mb-6">{t.aptsTitle}<span className="italic font-light">{t.aptsTitleItalic}</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          {reviews.map((r, i) => (
            ...
            >
              ...
              <p className="text-base font-serif italic mb-8 leading-relaxed flex-grow font-bold text-neutral-400">"{r.text}"</p>
        ...
        <div className="space-y-8">
          {items.map((item, i) => (
            ...
            >
              ...
              <p className="text-neutral-500 leading-relaxed pl-10">{item.a}</p>
            </motion.div>
          ))}
        </div>
      </div>
          ...
          <div className="order-2 lg:order-1">
            <div className="glass-dark p-10 rounded-[2rem] text-white">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h2 className="text-4xl md:text-5xl font-serif mb-8 leading-tight font-black text-neutral-400">{t.tennisTitle}<span className="italic font-medium">{t.tennisTitleItalic}</span></h2>
                <p className="text-neutral-400 font-sans font-medium leading-relaxed mb-8">
                  {t.tennisDesc}
                </p>
                <ul className="space-y-4 mb-10">
                  <li className="flex items-center text-neutral-400 font-bold">
                    <Check className="text-neutral-400 mr-3" size={22} strokeWidth={3} />
                    {t.tennisItem1}
                  </li>
                  <li className="flex items-center text-neutral-400 font-bold">
                    <Check className="text-neutral-400 mr-3" size={22} strokeWidth={3} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-neutral-500 text-lg leading-relaxed">
                <p>{t.storyP1}</p>
                <p>{t.storyP2}</p>
              </div>
