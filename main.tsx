              ...
              >
                <div className="aspect-[21/9] relative">
                  ...
                  <div className="absolute bottom-0 left-0 p-8 md:p-16 text-white max-w-3xl">
                    ...
                    <p className="text-white/70 text-sm md:text-lg mb-8 line-clamp-2 font-light">{posts[0].excerpt}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-20">
              {posts.slice(1).map((post, i) => (
                ...
                >
                  ...
                  <p className="text-neutral-500 text-sm leading-relaxed mb-6 line-clamp-3 font-light">{post.excerpt}</p>
