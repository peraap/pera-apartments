      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20">
            {/* Contact Info */}
            <div>
              <span className="text-sm uppercase tracking-[0.5em] font-bold text-white/60 mb-6 block">{t.tag}</span>
              <h1 className="text-4xl md:text-6xl font-display font-black mb-8 leading-tight text-white">{t.title.split('te ajutăm')[0]} <span className="italic font-light text-white/60">{lang === 'ro' ? 'te ajutăm.' : 'help you.'}</span></h1>
              <p className="leading-relaxed mb-12 max-w-lg font-bold text-white/90">
                {t.description}
              </p>

              <div className="space-y-10 mb-12">
                <div className="space-y-2 group">
                  <h4 className="text-[10px] uppercase tracking-widest font-black text-white/40 font-sans">{t.email}</h4>
                ...
                <div className="space-y-2 group">
                  <h4 className="text-[10px] uppercase tracking-widest font-black text-white/40 font-sans">{t.phone}</h4>
                  <div className="flex items-center gap-3">
                ...
                <div className="space-y-2 group">
                  <h4 className="text-[10px] uppercase tracking-widest font-black text-white/40 font-sans">{t.location}</h4>
                  <div className="flex items-center gap-3">
              ...
              <div className="flex space-x-8">
                <a href="https://www.instagram.com/pera.apartments" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 text-xs font-bold uppercase tracking-widest text-white/60 hover:text-white transition-colors">
                  <Instagram size={18} />
                  <span>Instagram</span>
                </a>
                <a href="https://www.facebook.com/profile.php?id=61579446541292#" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 text-xs font-bold uppercase tracking-widest text-white/60 hover:text-white transition-colors">
                  <Facebook size={18} />
                  <span>Facebook</span>
                </a>
              </div>
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    <label className="text-[10px] uppercase tracking-widest font-black text-white/40">{t.form.nameLabel}</label>
                    <input 
                      type="text" 
                      required
                      className="w-full bg-white/5 border border-white/10 px-6 py-4 rounded-xl text-sm focus:ring-1 focus:ring-white/30 outline-none transition-all text-white placeholder:text-white/20 font-bold"
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] uppercase tracking-widest font-black text-white/40">{t.form.emailLabel}</label>
                    <input 
                      type="email" 
                      required
                      className="w-full bg-white/5 border border-white/10 px-6 py-4 rounded-xl text-sm focus:ring-1 focus:ring-white/30 outline-none transition-all text-white placeholder:text-white/20 font-bold"
                ...
                <div className="space-y-3">
                  <label className="text-[10px] uppercase tracking-widest font-black text-white/40">{t.form.subjectLabel}</label>
                  <input 
                    type="text" 
                    required
                    className="w-full bg-white/5 border border-white/10 px-6 py-4 rounded-xl text-sm focus:ring-1 focus:ring-white/30 outline-none transition-all text-white placeholder:text-white/20 font-bold"
                ...
                <div className="space-y-3">
                  <label className="text-[10px] uppercase tracking-widest font-black text-white/40">{t.form.messageLabel}</label>
                  <textarea 
                    rows={4}
                    required
                    className="w-full bg-white/5 border border-white/10 px-6 py-4 rounded-xl text-sm focus:ring-1 focus:ring-white/30 outline-none resize-none transition-all text-white placeholder:text-white/20 font-bold"
