        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2">
            <div className="mb-16">
              ...
              <p className="text-lg md:text-xl leading-relaxed text-neutral-700 font-description italic border-l-4 border-neutral-200 pl-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                {apartment.amenities.map((item, i) => (
                  <div key={i} className="flex items-center space-x-3 text-sm group">
                    ...
                    <span className="text-neutral-700 font-semibold tracking-tight">{item}</span>
                  </div>
                ))}
              </div>
            </div>
